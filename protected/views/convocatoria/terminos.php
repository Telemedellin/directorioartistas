<div class="row-fluid">
	<div class="span12">
		...
		<ul>
			...
			<li>
				En caso de tener dudas técnicas sobre el formulario de inscripción o presenta algún problema para inscribirse, puede escribir al correo <a href="mailto:juan.martinez@telemedellin.tv" target="_blank">juan.martinez@telemedellin.tv</a>
			</li>
			<li>
			...
			<li>
				La organización de la Feria de la Flores 2015 aclara que <strong>diligenciar la inscripción no implica que la propuesta haya sido aceptada para participar en la programación</strong>. Todas deben pasar por el proceso de selección del jurado.
			</li>
			<li>
		...
		<h4>Escenarios de programación de la Feria de las Flores 2015</h4>
		<p>
		...
		<p>
			La organización de la Feria de las Flores 2015 quiere invitar a los artistas a realizar este trámite con tiempo suficiente y a no dejarlo para último momento. El llamado es también a que todo el sector cultural se apropie de la plataforma y participe activamente con su inscripción.
		</p>
	</div>
</div>
<div class="row-fluid">
	<div class="span6 offset3">
		<?php echo CHtml::beginForm('registro', "POST", array("class"=>"bs-docs-example")) ?>
